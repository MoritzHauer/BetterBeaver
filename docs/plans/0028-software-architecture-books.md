...
Status: **drafted** · Owner: Moe · Date: 2026-09-10 · One adversarial review round (14 findings, all addressed in this revision) · Prerequisites: none for the teaching track (§5 phase A); [plan 0027](0027-authored-questions-and-exam-mode.md) steps 3–8 and its step 10 schema-bump republish for the question track (phase B); 0027 steps 1–2 for the `exercises`/`practiceDepth` values in §4. The §6 amendments landed in 0027 on 2026-09-11. Seven owner decisions this session (§1).
...
Blocked on 0027 steps 3–8 (numbering as amended 2026-09-11). Publishing additionally waits on 0027 step 10 (the `CONTENT_SCHEMA_VERSION` → 3 republish, an owner step).
