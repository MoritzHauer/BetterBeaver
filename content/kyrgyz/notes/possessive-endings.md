...
Kyrgyz has no separate word for "my, your, his, her" — a suffix on the noun
itself marks possession, the same suffix used for the genitive case.
...
*Note: the manual's own possessive-ending table for сабак 4–5 is OCR-garbled
in places; the singular endings (-м/-ы, -ы/-ыы, -ыз) are read directly off
legible dialogue examples, but the plural row (биз/силер/сиздер/алар) endings
above follow the general Kyrgyz pattern rather than a clean source table —
flagged for owner/native-speaker review.*
